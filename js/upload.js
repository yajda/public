...
(function($){
    $.fn.ajaxImageUpload = function(options){
        ...
        var imageBox  = $("#" + inputId + "_show");
        var uploadBox = $("#" + inputId + "_box");
        ...
        var handleFileSelect = function(){
            ...
            // 获取最新的section数量
            var imageNum  = $('#'+ inputId +'_section').length;
            //alert(imageNum);
        ...
        var createDeleteModal = function () {
            ...
            var deleteModal   = $("<aside id='" + inputId + "_aside' class='delete-modal'><div class='modal-content'><p class='modal-tip'>您确定要删除作品图片吗？</p><p class='modal-btn'> <span class='confirm-btn'>确定</span><span class='cancel-btn'>取消</span></p></div></aside>");
            // 创建删除模态框
            deleteModal.appendTo('.image-box');

            // 显示弹框
            imageBox.delegate("#" + inputId + "_delete","click",function(){
        ...
        var createImageSection = function () {
            ...
            var imageSection = $("<section id='" + inputId + "_section' class='image-section image-loading'></section>");
            var imageShade   = $("<div class='image-shade'></div>");
            var imageShow    = $("<img id='" + inputId + "_upload' class='image-show image-opcity' />");
            var imageInput   = $("<input class='" + inputName + " " + inputId + "' name='" + hidenInputName + "[]' value='' type='hidden'>");
            var imageZoom    = $("<div class='image-zoom'></div>");
            var imageDelete  = $("<div id='" + inputId + "_delete' class='image-delete'></div>");
